"""OCR cleanup and processing utilities.

This module contains the OCR cleanup pipeline for processing OCR text.
No major changes needed from the original implementation - already works
in background tasks. Ensured compatibility with ARQ async context.
"""
