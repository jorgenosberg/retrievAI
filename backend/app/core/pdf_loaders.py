"""PDF document loaders using PyMuPDF4LLM.

This module provides custom PDF loaders compatible with LangChain.
"""
...
from app.core.pdf_parsers import PyMuPDF4LLMParser
