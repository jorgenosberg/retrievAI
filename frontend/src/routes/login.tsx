...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-rose-100 dark:from-zinc-950 dark:to-zinc-900 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-zinc-100">RetrievAI</h1>
        ...
        <div className="mt-6 text-center">
          <a href="/register" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 text-sm">
