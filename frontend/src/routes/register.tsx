...
function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-linear-to-br from-primary-50 to-indigo-100 dark:from-primary-900/20 dark:to-indigo-900/20 flex items-center justify-center p-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              id="fullName"
              className="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 dark:bg-zinc-800 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400"
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full bg-primary-600 text-white py-2 px-4 rounded-md hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-400 disabled:opacity-50 ${loading ? "cursor-progress" : "cursor-pointer"} disabled:cursor-not-allowed`}
          >
